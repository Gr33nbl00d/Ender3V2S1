...
#define CUSTOM_MACHINE_NAME "Gr33nbloodConf"
...
#define Z_MIN_PROBE_ENDSTOP_HIT_STATE LOW  // Default is HIGH, needs to be LOW for a BQMPv2
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 138 }  // Ender Configs
 ...
 */
#define FIX_MOUNTED_PROBE  // Usually disabled for BLTOUCH, needs to be enabled for BQMPv2
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -54.3, -11.3, -1.12 }  // MRiscoC BLTouch offset for support: https://www.thingiverse.com/thing:4605354 (z-offset = -1.80 mm)
...
#define PREHEAT_BEFORE_LEVELING  // MRiscoC Heatting to compensate thermal expansions
  ...
  #define LEVELING_NOZZLE_TEMP   0   // (°C) Only applies to E0 at this time  // MRiscoC No necessary for Microprobe
